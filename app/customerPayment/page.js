...
const CustomerPayment = () => {
  ...
  useEffect(() => {
    axios
      .get("http://192.168.1.40:5000/api/customer/customers")
  ...
  useEffect(() => {
    if (selectedCustomer) {
      axios
        .get(`http://192.168.1.40:5000/api/customer/customers/${selectedCustomer}`)
        .then((response) => {
  ...
  //       `http://192.168.1.40:5000/api/customer/updateBalance/${selectedCustomer}`,
  //       {
  //         debit: debitAmount,
  //       }
  //     );
  ...
  //       `http://192.168.1.40:5000/api/customer/customers/${selectedCustomer}`
  //     );
  ...
  //     await axios.delete(
  //       `http://192.168.1.40:5000/api/customer/customers/${selectedCustomer}/dateWiseRecords/${recordId}`
  //     );
  ...
  const handleDeleteConfirmation = async () => {
    try {
      // Delete the record on the server
      await axios.delete(
        `http://192.168.1.40:5000/api/customer/customers/${selectedCustomer}/dateWiseRecords/${deleteRecordId}`
      );
