...
const Tables = () => {
    ...
    const handleView = async (tableId) => {
        try {
            const response = await axios.get(`http://192.168.1.40:5000/api/table/tables/${tableId}`);
    ...
    useEffect(() => {
        const fetchTables = async () => {
            try {
                const tablesResponse = await axios.get('http://192.168.1.40:5000/api/table/tables');
        ...
        const fetchSections = async () => {
            try {
                const sectionsResponse = await axios.get('http://192.168.1.40:5000/api/section');
...
const handleAddSubmit = async () => {
    try {
        ...
        const response = await axios.post(
            `http://192.168.1.40:5000/api/table/${sectionId}/tables`,
            { numberOfTables },
            {
                headers: {
    ...
    useEffect(() => {
        const fetchtables = async () => {
            try {
                const response = await axios.get('http://192.168.1.40:5000/api/table/tables');
    ...
    const confirmDelete = async () => {
        try {
            ...
            const response = await axios.delete(
                `http://192.168.1.40:5000/api/table/tables/${tableToDelete._id}`
            );
    ...
    const handleEditSubmit = async () => {
        try {
            ...
            const response = await axios.patch(
                `http://192.168.1.40:5000/api/table/tables/${editTable._id}`,
                formData,
                {
                    headers: {
                        'Content-Type': 'application/json',
