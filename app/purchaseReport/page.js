...
const PurchaseReport = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const purchasesResponse = await axios.get("http://192.168.1.40:5000/api/purchase/purchases");
        ...
        const vendorsResponse = await axios.get("http://192.168.1.40:5000/api/supplier/suppliers");
